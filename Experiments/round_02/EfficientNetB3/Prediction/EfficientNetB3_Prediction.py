# Round 2 - EfficientNetB3 Test Prediction 
...
OUTPUT_DIR = (
    PROJECT_ROOT
    / "outputs"
    / "round10_EfficientNetB3_prediction_outputs"
)
...
# EfficientNetB3 handles normalization internally.
...
def save_confusion_matrix_png(
    ...
    plt.title(
        "Round 10 Held-Out Test — EfficientNetB3"
    )
...
def main():
    ...
    if not MODEL_PATH.exists():
        raise FileNotFoundError(
            ...
            "Run the Round 10 EfficientNetB3 training script first."
        )
    ...
    with mlflow.start_run(
        run_name="Round_10_EfficientNetB3_held_out_test_prediction"
    ):
        mlflow.set_tags({
        ...
        predictions_path = (
            OUTPUT_DIR
            / "prediction_results_EfficientNetB3_round10_test.csv"
        )

        report_txt_path = (
            OUTPUT_DIR
            / "classification_report_EfficientNetB3_round10_test.txt"
        )

        report_csv_path = (
            OUTPUT_DIR
            / "classification_report_EfficientNetB3_round10_test.csv"
        )

        cm_csv_path = (
            OUTPUT_DIR
            / "confusion_matrix_EfficientNetB3_round10_test.csv"
        )

        cm_png_path = (
            OUTPUT_DIR
            / "confusion_matrix_EfficientNetB3_round10_test.png"
        )

        summary_path = (
            OUTPUT_DIR
            / "prediction_summary_EfficientNetB3_round10_test.csv"
        )

        metrics_json_path = (
            OUTPUT_DIR
            / "prediction_metrics_EfficientNetB3_round10_test.json"
        )
        ...
        print(
            "ROUND 10 EfficientNetB3 HELD-OUT TEST "
