# Round 2 - ResNet50 Training with MLflow
...
HISTORY_PATH = os.path.join(
    BASE_DIR,
    "training_history_ResNet50_round10.csv"
)

METRICS_PATH = os.path.join(
    BASE_DIR,
    "evaluation_metrics_ResNet50_round10.csv"
)
...
print(
    f"Plastic classes: {class_names}"
)

print(
    f"Total image groups: {len(image_dict)}"
)
...
print(
    f"Training images   : {len(train_paths_raw)}"
)
...
MODEL_SUMMARY_PATH = os.path.join(
    BASE_DIR,
    "model_summary_ResNet50_round10.txt"
)
...
def evaluate_dataset(
    ...
    report_path = os.path.join(
        BASE_DIR,
        f"classification_report_ResNet50_round10_{split_name}.txt"
    )

    cm_path = os.path.join(
        BASE_DIR,
        f"confusion_matrix_ResNet50_round10_{split_name}.csv"
    )

    prediction_path = os.path.join(
        BASE_DIR,
        f"prediction_results_ResNet50_round10_{split_name}.csv"
    )
...
with mlflow.start_run(
    run_name="Round_10_ResNet50_70_20_10"
):
    ...
    print("\n" + "=" * 70)
    print("TRAINING - ROUND 10 RESNET50")
    print("=" * 70)
    ...
    print("\n" + "=" * 70)
    print("ROUND 10 RESNET50 COMPLETED")
    print("=" * 70)
