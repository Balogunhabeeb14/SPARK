# Round 9 - EfficientNetB3 Training 
...
HISTORY_PATH = os.path.join(
    BASE_DIR,
    "training_history_EfficientNetB3_round9.csv"
)

METRICS_PATH = os.path.join(
    BASE_DIR,
    "evaluation_metrics_EfficientNetB3_round9.csv"
)
...
# A non-shuffled version is used for the final training evaluation.
...
# EfficientNetB3 includes its own input normalization.
...
MODEL_SUMMARY_PATH = os.path.join(
    BASE_DIR,
    "model_summary_EfficientNetB3_round9.txt"
)
...
def evaluate_dataset(
    ...
    report_path = os.path.join(
        BASE_DIR,
        f"classification_report_EfficientNetB3_round9_{split_name}.txt"
    )

    cm_path = os.path.join(
        BASE_DIR,
        f"confusion_matrix_EfficientNetB3_round9_{split_name}.csv"
    )

    prediction_path = os.path.join(
        BASE_DIR,
        f"prediction_results_EfficientNetB3_round9_{split_name}.csv"
    )
...
with mlflow.start_run(
    run_name="Round_9_EfficientNetB3_70_20_10"
):
    ...
    print("\n" + "=" * 70)
    print("TRAINING - ROUND 9 EFFICIENTNETB3")
    print("=" * 70)
    ...
    summary_json_path = os.path.join(
        BASE_DIR,
        "round9_summary_EfficientNetB3.json"
    )
    ...
    print("\n" + "=" * 70)
    print("ROUND 9 EFFICIENTNETB3 COMPLETED")
    print("=" * 70)
